...
func _ready() -> void:
	...
	draw_pile_button.pressed.connect(draw_pile_view.show_current_view.bind("Karten Deck", true))
	discard_pile_button.pressed.connect(discard_pile_view.show_current_view.bind("Benutzte Karten"))
